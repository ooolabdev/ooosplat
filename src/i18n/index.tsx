...
const zhCN = {
  ...
  "gpu.recheck": "重新检测",
  "gpu.rechecking": "检测中…",
  "gpu.conflictsTitle": "检测到可能拦截 GPU 的模块",
  "gpu.conflictsHint": "这些是可能影响 NVML 的第三方内核模块。OOOSplat 只报告，不会自动停止、禁用或修改它们。",
  "gpu.conflictAdviceTitle": "建议处理方式",
  "gpu.conflictAdvice1": "先退出相关游戏、反作弊或加速器，再点击“重新检测”。",
  "gpu.conflictAdvice2": "若问题只在某个软件启动后出现，优先使用该软件自身的退出、修复或卸载选项，不要手动禁用内核驱动。",
  "gpu.conflictAdvice3": "仍失败时更新 NVIDIA 驱动和相关软件并重启；必要时收集应用日志后再联系软件厂商。",
  "gpu.scriptTitle": "生成关闭 / 恢复脚本",
  "gpu.scriptRisk": "脚本会请求管理员权限，并可能停止第三方游戏反作弊、加速器或网络过滤内核服务。只在确认影响、已退出相关软件并保留恢复路径时执行。",
  "gpu.scriptGenerate": "显示脚本",
  "gpu.scriptLoading": "生成中…",
  "gpu.scriptCopying": "复制中…",
  "gpu.copyScript": "复制脚本",
  "gpu.scriptCopied": "脚本已复制",
  "gpu.runClose": "一键关闭（需确认）",
  "gpu.runRestore": "一键恢复（需确认）",
  "gpu.scriptLaunched": "已打开管理员 PowerShell，请在窗口中再次输入确认词",
  "gpu.scriptFailed": "脚本操作失败",
  ...
  "dialog.gpuScriptTitle": "运行 GPU 冲突脚本",
  "dialog.gpuScriptClose": "将打开可见的管理员 PowerShell。脚本会先备份启动类型，再停止并禁用列出的第三方内核服务；可能影响游戏、反作弊或网络功能。继续吗？",
  "dialog.gpuScriptRestore": "将打开可见的管理员 PowerShell。脚本会按 ProgramData 中的备份恢复启动类型。只有确认备份来自本机并希望恢复时才继续。",
...
const en: Record<TranslationKey, string> = {
  ...
  "gpu.recheck": "Re-check", "gpu.rechecking": "Checking…", "gpu.conflictsTitle": "Modules that may block GPU access", "gpu.conflictsHint": "These third-party kernel modules may interfere with NVML. OOOSplat reports them only and will not stop, disable, or modify them automatically.", "gpu.conflictAdviceTitle": "Recommended next steps", "gpu.conflictAdvice1": "Exit the related game, anti-cheat, or accelerator, then click Re-check.", "gpu.conflictAdvice2": "If the issue starts with one app, use that app's own exit, repair, or uninstall flow instead of disabling its kernel driver.", "gpu.conflictAdvice3": "If it persists, update the NVIDIA driver and related software, reboot, and collect app logs before contacting the vendor.", "gpu.scriptTitle": "Generate close / restore script", "gpu.scriptRisk": "The script requests administrator access and may stop third-party game anti-cheat, accelerator, or network-filter kernel services. Run it only after confirming the impact, exiting related software, and preserving a recovery path.", "gpu.scriptGenerate": "Show script", "gpu.scriptLoading": "Generating…", "gpu.scriptCopying": "Copying…", "gpu.copyScript": "Copy script", "gpu.scriptCopied": "Script copied", "gpu.runClose": "Close with one click (confirm)", "gpu.runRestore": "Restore with one click (confirm)", "gpu.scriptLaunched": "Administrator PowerShell opened; type the confirmation word in that window", "gpu.scriptFailed": "Script operation failed",
